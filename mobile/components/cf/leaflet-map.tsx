  ...
  <script>
    (function () {
      ...
      function buildMarker(m) {
        ...
        // All pins render as standard sharp pins now. Pre-mig-54 the
        // .cf-pin--imprecise modifier (faded + dashed halo) was applied
        // to city/county/unknown precision rows. Post-revival the
        // badge layer carries those — they never reach the pin layer.
        // The `precision` prop is left in the marker for diagnostics
        // and future use; the visual is unconditionally sharp.
        var icon = L.divIcon({
          className: 'cf-pin',
          html: svg.html,
