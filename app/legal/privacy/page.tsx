      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            'If you delete your account from the app\'s Me → Delete account screen, your email is permanently deleted from our active database within 7 days. Supabase retains backup copies of authentication data for up to 30 days, after which your email is purged from all systems. Saved cases live in storage on your phone, not on our servers — they are removed when you sign out, when you uninstall the app, or when you clear the app\'s storage in your device settings.',
          ],
        },
        {
